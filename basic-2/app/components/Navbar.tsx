        ...
        <>
            <div className="flex justify-between items-center w-full h-[10vh] z-10">
                ...
                <div className="flex-grow h-full flex justify-center space-x-16 items-center">
                    ...
                    <Link href="/cubesat" className='font-poppins font-medium text-xl hover:scale-110 transition duration-500'>Blog</Link>
                </div>
                <Link href="/contact" className='mr-[115px] relative flex items-center justify-center w-[144px] h-[45px] text-center font-poppins font-medium text-xl rounded-3xl bg-transparent border-2 border-transparent hover:scale-110 transition duration-500 gradient-border'>
