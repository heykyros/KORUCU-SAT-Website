...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className='w-full lg:w-[40vw] flex flex-col items-center lg:place-self-start mt-[20vh] lg:mt-16 h-auto'>
          <div className='lg:hero-page-content lg:ml-[5vw] flex flex-col items-center lg:items-start text-center lg:text-start'>
            <h1 className='flex-row font-semibold lg:leading-[10vh] font-poppins text-5xl lg:text-7xl mb-2 lg:mb-0'>
              Astronomy Society of <span className='bg-gradient-to-r from-custom-purple to-custom-orange bg-clip-text text-transparent'>
                FSA
              </span>
            </h1>
      ...
      className='mt-[30vh] lg:mt-[60vh] flex w-full flex-col items-center'>
      <h1 className="font-poppins font-semibold text-neutral-100 text-5xl lg:text-6xl text-center w-3/4 lg:w-1/2" id="who-we-are">Who We Are</h1>
      ...
      <Link href="/about" className="font-poppins text-button-purple text-2xl mt-[6vh] w-full flex justify-center items-center">OUR MISSION  
